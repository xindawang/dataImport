...
import dataImport.ChineseVersion.tools.daoTest;
...
public class dataImportDao {
    ...
    public static void insertXml(String elementName, String compound,String type){
        ...
        String sqlStr = "insert into DATA_DIC_ENG_XML(DATA_ELEMENT_NAME,SIMPLE_OR_COMPOUND,DATA_TYPE) values(?,?,?)";
        int count = 0;
    ...
    public static void insertXml(String elementName, String compound,String type,int minLen,int maxLen){
        connection = getConnection();
        String sqlStr = "insert into DATA_DIC_ENG_XML(DATA_ELEMENT_NAME,SIMPLE_OR_COMPOUND,DATA_TYPE,MIN_LEN,MAX_LEN) values(?,?,?,?,?)";
        int count = 0;
    ...
    public static void insertXml(String elementName, String compound,String type,int minLen,int maxLen,int minVal,int maxVal){
        connection = getConnection();
        String sqlStr = "insert into DATA_DIC_ENG_XML(DATA_ELEMENT_NAME,SIMPLE_OR_COMPOUND,DATA_TYPE,MIN_LEN,MAX_LEN,MIN_VAL,MAX_VAL) values(?,?,?,?,?,?,?)";
        int count = 0;
    ...
    public static void insertDic(String elementName, String acr,String format,String xmlName,String subElement,String attribute,
        ...
        connection = getConnection();
        String sqlStr = "insert into DATA_DIC_ENG(DATA_ELEMENT_NAME,TEI_OR_ACRONYM,FORMAT,XML_DATA_TYPE," +
    ...
    public static void insertSubElement(String name,String subElementName,String required,String repeatable){
        ...
        connection = getConnection();
        if (name.contains("adjustableCostDetails")){
            name ="adjustableCostDetails";
        }
        String insert = "insert into DATA_DIC_ENG_SUB(SUPER_DATA_ELEMENT,DATA_ELEMENT_NAME,REQUIED,REPEATABLE) values(?,?,?,?)";
    ...
    public static void insertCode(String name,String codeName,String description,String specification){
        ...
        String insert = "insert into DATA_DIC_ENG_CODE(DATA_ELEMENT_NAME,CODE_NAME,DESCRIPTION,SPECIFICATION) values(?,?,?,?)";
